 ...
 */
class TestAnnotationParserPBCProxied
{
    /**
     * @pre $param1 < 27
     *
     ...
     * @return mixed
     */
    protected function getConditions($docBlock, $conditionKeyword)
    {
     ...
     * @param $docString
     */
    protected function parseAssertion($docString)
    {
     ...
     *
     */
    protected function parseFunctionName($docBlock)
    {
     ...
     * @return string
     */
    protected function getClassNamespace($fileName)
    {
